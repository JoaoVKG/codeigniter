    ...
    <div class="admin-content">
      <div class="ui inverted fixed menu mobile only">
        <div class="ui container">
          <a class="active item" href='<?= base_url("/grupo/".$grupo['slug']);?>'><i class="left arrow icon"></i>Voltar</a>
          ...
          <div class="right menu">
            <div class="ui item dropdown">
              ...
              <div class="menu">
                ...
                <a href="/codeigniter/login" class="item">aq</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="middle-content padding margin" id="conteudomenu">
